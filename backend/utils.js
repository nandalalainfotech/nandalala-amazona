...
//   <td align="right"> $${save.shippingPrice.toFixed(2)}</td>
//   </tr>
//   <tr>
//   <td colspan="2"><strong>Total Price:</strong></td>
//   <td align="right"><strong> $${save.totalPrice.toFixed(2)}</strong></td>
//   </tr>
//   <tr>
...
//   <p>
//   ${save.shippingAddress.fullName},<br/>
//   ${save.shippingAddress.address},<br/>
//   ${save.shippingAddress.city},<br/>
//   ${save.shippingAddress.country},<br/>
//   ${save.shippingAddress.postalCode}<br/>
//   </p>
//   <hr/>
//   <p>
